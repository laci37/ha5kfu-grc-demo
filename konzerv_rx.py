...
# Title: Konzerv Rx
# Generated: Thu Mar 25 16:47:14 2021
##################################################
...
class konzerv_rx(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Konzerv Rx")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, (firdes.low_pass(1.0, samp_rate, 3e5, 1e4)), center_freq, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps((firdes.low_pass(1.0, self.samp_rate, 3e5, 1e4)))
